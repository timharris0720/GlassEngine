...
FUNCTION_OFFSET_INSTANCE         equ 2856    ; The offset of 'phys_dev_ext_disp_functions' within a 'loader_instance' struct
PHYS_DEV_OFFSET_INST_DISPATCH    equ 720     ; The offset of 'phys_dev_ext' within in 'loader_instance_dispatch_table' struct
...
EXT_OFFSET_DEVICE_DISPATCH       equ 4304    ; The offset of 'ext_dispatch' within a 'loader_dev_dispatch_table' struct
